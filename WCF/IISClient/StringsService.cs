...
public interface IStringsService
{
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStringsService/StringContainsOtherString", ReplyAction="http://tempuri.org/IStringsService/StringContainsOtherStringResponse")]
...
public partial class StringsServiceClient : System.ServiceModel.ClientBase<IStringsService>, IStringsService
{
    ...
    {
        return base.Channel.StringContainsOtherString(first, second);
    }
}
